...
def setMetadata(metadataFolder, inputFolder, key, value, *, fileExtension='.xml'):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--inputFolder', required= True, help='Folder read the files from')
    ...
    parser.add_argument('--fileExtension', required= False, default='.xml', help='File extension of the files in the input folder')

    args = parser.parse_args()

    setMetadata(args.metadataFolder, args.inputFolder, args.key, args.value, fileExtension=args.fileExtension)